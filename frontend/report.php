...
<body>
    ...
    <div class="main-content">
        <form id="report-form" style="margin-bottom:24px;">
            ...
            <span style="font-size:0.95em;color:#888;">You can type or pick a date (format: YYYY-MM-DD)</span>
    ...
    <script>
            ...
            fetch(`../backend/order.php?action=report_by_date&date=${date}`)
                .then(async res => {
                    ...
                    try {
                        ...
                        reportHtml += `<table class='most-ordered-table'>`;
                        ...
                        // Show backend error in UI for debugging
        ...
        pdfBtn.addEventListener('click', function() {
            ...
            // Force reflow and wait for DOM update before exporting
            setTimeout(function() {
                html2pdf().set({
                    margin: 0.2,
